...
int i,j,main_exit;            // GOLBAL VARAIBLE



void new_records();
void update_records();
void view_records();             //Function Declartion
void view_stu_rec();
void remove_records();
void about();
void close();
...
struct date
{
    int day,month,year;  // defining structures
};
struct
{
    char roll_no[10];
...
{
   int a=0,i=0;
    char u_name[10],c=' ';  //login page
    char p_word[10];
    char admin[10]="admin";
    char password[10]="admin076";
    do
{
	system("cls");
	...
	{
	printf("  \n\n\n       WELCOME USER YOU HAVE SUCCESSFULLY LOGIN \n");
	system("PAUSE");
	break;
	}
	else
	{
		printf("\n        SORRY THE  USERNAME OR PASSWORD WAS INCORRECT\n");
		system("PAUSE");
		a++;
	...
	if (a>2)
	{
		printf("\nSorry you have entered  wrong Username OR Password for four times");
...
void main_menu()
{
    ...
    system("CLS");
    printf("\n\n\t\t\t 20IT076 HOSTEL MANAGEMENT SYSTEM\n");
    printf("\n\n\n\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2 WELCOME TO  NAVIGATOR BAR \xB2\xB2\xB2\xB2\xB2\xB2\xB2");
...
printf("\nEnter Roll Number:");
    ...
    printf("\n Enter your hostel name(SHAHJANAND / NISARG  :");
    ...
    if(strcmp(add.hostel_name,"SHAJANAND")==0 || strcmp(add.hostel_name,"SHAHJANAND")==0)
    {
        FILE *hostel;
        hostel=fopen("SHAHJANAND.dat","a+");
        if(hostel==NULL)
        {
        printf("File not found");
        exit(1);}
    ...
    else if(strcmp(add.hostel_name,"SHAHJANAND")==0 || strcmp(add.hostel_name,"NISARG")==0)
    {
     FILE *hostel;
     hostel=fopen("NISARG.dat","a+");
     if(hostel==NULL)
     {
        printf("File not found");
        exit(1);
    ...
    add_invalid:
    printf("\n\n\n\tEnter 1 to go to the navigator bar \n\tEnter 0 to exit the system:");
    scanf("%d",&main_exit);
...
void update_records()
{
...

    {
        ...
        {   test=1;
            ...
            if(choice==1)
                ...
                {
                printf("Enter the father's mobile number:");
    ...
    edit_invalid:
		printf("\n\nEnter 0 To try again\nEnter 1 To return navigator bar \nEnter 2 To exit:");
        scanf("%d",&main_exit);
        if (main_exit==1)
			main_menu();
        else if (main_exit==2)
...
void view_records()
{
    ...
    switch(choice)
    {
    	case 1: hostel=fopen("SAHAJANAD.dat","a+");break;
    	case 2: hostel=fopen("NISARG.dat","a+");break;
...
{
    system("CLS");
    printf("\n\n\n\t\tThis System is created by Mit Pandya 20IT076 For SGP 1 Subject\n\t\t\n\n\n\n\n\n\n\n\n");
    getch();
}
//------------------------------------------------------------------------------------------------------------------
...
{
	system("CLS");
    printf("\n\n\n\n\t\tThank You From 20IT076-Have a great DAY Ahead!!! \n\n\t\t\t\t\t~Mit Pandya\a\a\a\n\n\n\n\n\n\n");
    getch();
}
